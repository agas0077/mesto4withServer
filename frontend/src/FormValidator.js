export default class FormValidator {
    ...
    // Если checkValidity() возвращает fasle, то функция редактирует внешний вид блоков с сообщениями об ошибке
    ...
    // Если ошибка была исправлена или checkValidity() изначально возвращала true, то либо все возвращается назад, 
    // либо просто ничего не происходит
